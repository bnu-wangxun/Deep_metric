...
class YOLO_TF:
    ...
    def detect_from_cvmat(self, img):
        ...
        net_output = self.sess.run([self.fc_32, self.fc_29], feed_dict=in_dict)

    # 		net_output_ = self.sess.run(self.fc_29,feed_dict=in_dict)
    # 		print('type of net output_ is', type(net_output_))
...
def show_results(self, img, results):
    ...
    if self.filewrite_img:
        if self.disp_console: print
        '    image file writed : ' + self.tofile_img
